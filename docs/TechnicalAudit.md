...
| `apps/server/controllers/ai.controller.js`, `services/ai.service.js`, `routes/ai.routes.js` | `apps/server` | **Keep as 0-byte placeholders.** They cost nothing and record the intended shape. Do **not** fill them. |
