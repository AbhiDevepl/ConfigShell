...
export function AppCard({ app, selected, onToggle, onOpenDetails }: AppCardProps) {
  ...
  return (
    <label
      ...
      htmlFor={inputId}
      className={cn(
        'group relative flex cursor-pointer flex-col justify-between gap-2 rounded-lg border p-3 transition-colors has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-ring has-[:focus-visible]:ring-offset-1 has-[:focus-visible]:ring-offset-background select-none',
